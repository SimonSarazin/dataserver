...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bucket.user_created'
        db.add_column(u'bucket_bucket', 'user_created',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bucket.user_created'
        db.delete_column(u'bucket_bucket', 'user_created')
    ...
    models = {
        ...
        u'bucket.bucket': {
            ...
            'user_created': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        u'bucket.bucketfile': {
